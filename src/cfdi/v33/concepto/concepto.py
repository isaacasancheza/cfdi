...
from cfdi.v33.concepto.cuenta_predial import CuentaPredial
from cfdi.v33.concepto.impuestos import Impuestos
from cfdi.v33.concepto.informacion_aduanera import InformacionAduanera
from cfdi.v33.concepto.parte import Parte
...
class Concepto(
    ...
    # complemento_concepto: list[dict] = []  # TODO agrega timbre fiscal digital
    """
    ...
    valor_unitario: float = attr('ValorUnitario')
    """
    ...
    descuento: fields.NonNegativeSixDecimals | None = attr('Descuento', default=None)
    """
