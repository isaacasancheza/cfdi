...
def test_base():
    ...
    assert cfdi.cfdi_relacionados.tipo_relacion == '09'
    ...
    assert cfdi.emisor.regimen_fiscal == '630'
    ...
    assert cfdi.receptor.regimen_fiscal_receptor == '630'
    ...
    assert (
        cfdi.conceptos[1].a_cuenta_terceros[0].regimen_fiscal_a_cuenta_terceros == '630'
    )
    assert (
